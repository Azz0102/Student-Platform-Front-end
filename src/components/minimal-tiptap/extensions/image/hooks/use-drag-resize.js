...
export function useDragResize({
  ...
  const handlePointerMove = useCallback(
    ...
    [resizeDirection, resizeOrigin, gridInterval, boundaryWidth, initialDimensions.width, widthConstraint, contentHeight, contentWidth, updateDimensions, minWidth, minHeight]
  )
  ...
  const handleKeydown = useCallback(
    ...
    [updateDimensions, initialDimensions.width, initialDimensions.height, minWidth, minHeight]
  )
